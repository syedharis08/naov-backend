...
You are invited by {{ $user->name }} from {{ $user->company_name}} to manage their shipment on Naov!
<br>
<br>
...
Join {{ $user->name}} in this cause and together help us make a difference in the world.
