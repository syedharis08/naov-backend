...
Route::middleware('api')->group(function () {
    ...
    Route::post('add-forwarders', [UserController::class, 'addForwarders'])->middleware('throttle:1,1');
    Route::get('get-shippers', [UserController::class, 'getShippers']);
    Route::post('add-shipper', [UserController::class, 'addShipper'])->middleware('throttle:1,1');
