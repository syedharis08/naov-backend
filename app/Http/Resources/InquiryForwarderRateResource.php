...
class InquiryForwarderRateResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        $data =  [
            ...
            'forwarder' => $this->inquiryForwarder->forwarder ?? null,
            ...
            "vessel_departure" => $this->inquiryForwarder->inquiry->vessel_departure,
            "ship_transit_time"  => $this->ship_transit_time,
            "etd"  => $this->etd,
            "forwarder_rate_notes"  => $this->forwarder_rate_notes,
            "status" => $this->inquiryForwarder->status,
